...
public class StudentsController {
	...
	public String addStudents(@Valid @ModelAttribute StudentsModel students, RedirectAttributes redirectAttr, BindingResult result) {
		String msg = "";
		if(result.hasErrors()) {
	...
	public String update(@Valid @ModelAttribute StudentsModel student,RedirectAttributes redirectAttr,BindingResult result) {
		String msg = "";
		redirectAttr.addFlashAttribute("status", "error");
		try {
